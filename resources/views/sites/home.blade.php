					...
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								{{config('landingpage.section_text_banner_1')}}		
							</h1>
							<p class="pt-10 pb-10">
								{{config('landingpage.section_text_banner_1_kecil')}}
							</p>
							<a href="{{config('landingpage.button_message_url')}}" class="primary-btn text-uppercase">{{config('landingpage.button_message')}}</a>
						</div>										
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('landingpage.content_text_1')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('landingpage.content_text_caption_1')}}
									</p>
									<a href="{{config('landingpage.content_text_gabung_url_1')}}">{{config('landingpage.content_text_gabung_1')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('landingpage.content_text_2')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('landingpage.content_text_caption_2')}}
									</p>
									<a href="{{config('landingpage.content_text_gabung_url_2')}}">{{config('landingpage.content_text_gabung_2')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('landingpage.content_text_3')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('landingpage.content_text_caption_3')}}
									</p>
									<a href="{{config('landingpage.content_text_gabung_url_3')}}">{{config('landingpage.content_text_gabung_3')}}</a>									
								</div>
							</div>
						</div>												
					</div>
